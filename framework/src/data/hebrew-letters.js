...
export const hebrewLetters = [
  ...
  { letter: 'ך', name: 'כָּף סוֹפִית',  nameNikud: 'כָּף סוֹפִית',     sound: 'k',  exampleWord: 'מֶלֶךְ',   emoji: '👑',  isFinal: true  },
  { letter: 'ל', name: 'לָמֵד',       nameNikud: 'לָמֵד',           sound: 'l',  exampleWord: 'לֵב',    emoji: '❤️', isFinal: false },
  { letter: 'מ', name: 'מֵם',        nameNikud: 'מֵם',             sound: 'm',  exampleWord: 'מַיִם',   emoji: '💧',  isFinal: false },
  { letter: 'ם', name: 'מֵם סוֹפִית',  nameNikud: 'מֵם סוֹפִית',      sound: 'm',  exampleWord: 'שָׁמַיִם',  emoji: '🌤️', isFinal: true  },
  ...
  { letter: 'ע', name: 'עַיִן',       nameNikud: 'עַיִן',            sound: '',   exampleWord: 'עוּגָה',  emoji: '🎂',  isFinal: false },
  { letter: 'פ', name: 'פֵּא',        nameNikud: 'פֵּא',             sound: 'p',  exampleWord: 'פִּיל',   emoji: '🐘',  isFinal: false },
  { letter: 'ף', name: 'פֵּא סוֹפִית',  nameNikud: 'פֵּא סוֹפִית',     sound: 'p',  exampleWord: 'אַף',    emoji: '👃',  isFinal: true  },
  { letter: 'צ', name: 'צַדִּי',       nameNikud: 'צַדִּי',           sound: 'ts', exampleWord: 'צָב',    emoji: '🐢',  isFinal: false },
