 ...
 *
 * כל השמעה עוברת שרשרת ספקים לפי סדר איכות וזמינות:
 *   1. בנק הצלילים - הקלטות אנושיות (מורה/הורה) ב-IndexedDB. הכי טוב
 *      פדגוגית ועובד תמיד, גם בלי רשת.
 *   2. TTS - רק כשיש רשת או קול מערכת (ראו tts.js). איכות טובה אך תלוי סביבה.
