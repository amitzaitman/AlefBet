...
היא מריצה lint, בדיקת טיפוסים, בדיקות יחידה, בנייה נקייה, בדיקות דפדפן
ובדיקת יציבות עדכוני אופליין ב-WebKit. כשל עוצר את התהליך.
...
`npm run verify` כולל בדיקות מגע ו-WebKit, וגם בדיקת יציבות אופליין חוזרת.
