...
export function startGame(container) {
  return runFractionGame(container, {
    ...
    rounds: () => [
      { a: [1, 4], b: [3, 4] }, { a: [1, 2], b: [1, 4] },
      { a: [2, 3], b: [1, 3] }, { a: [1, 3], b: [1, 2] },
      { a: [3, 4], b: [2, 3] }, { a: [1, 2], b: [2, 4] },
    ],
    build: ({ a, b }) => ({
      prompt: 'אֵיפֹה הַשֶּׁבֶר הַגָּדוֹל יוֹתֵר?',
      hints: [
        'הַשְׁווּ אֶת הָאֹרֶךְ הַצָּבוּעַ. שְׁנֵי הַשְּׁלֵמִים בְּאוֹתוֹ גֹּדֶל.',
        'הִסְתַּכְּלוּ אֵיפֹה הַצֶּבַע נִגְמָר בְּכָל פַּס. הַאִם הוּא מַגִּיעַ לְאוֹתוֹ מָקוֹם?',
        'הַכַּרְטִיס הַמֻּדְגָּשׁ יַעֲזֹר לָכֶם. הַשְׁווּ שׁוּב אֶת הַפַּסִּים.',
      ],
      success: a[0] * b[1] === b[0] * a[1] ? 'חֵצִי וּשְׁנֵי רְבָעִים הֵם אוֹתָהּ כַּמּוּת!' : 'כָּל הַכָּבוֹד!',
      options: [
