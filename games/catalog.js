  ...
  root.ALEFBET_CATALOG = [
    {
      ...
      desc: 'חָבַר כָּל אוֹת לַחַיָּה שֶׁמַּתְחִילָה בָּהּ — 8 סִיבוּבִים מִתּוֹךְ 22 אוֹתִיּוֹת',
      kind: 'game',
      icon: 'letters',
    ...
    },
    {
      ...
      desc: 'גְּרֹור אֶת סֵמֶל הַנִּיקּוּד לְאוֹת הַמַּתְאִימָה — לוֹמְדִים קָמָץ, חִירִיק, חוֹלֵם וְעוֹד',
      kind: 'game',
      icon: 'nikud',
      play: 'שַׂחֵק עַכְשָׁיו ▶',
    },
